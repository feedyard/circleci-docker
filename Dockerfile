...
RUN apk add --no-cache bash bash-doc bash-completion curl wget openssl openrc python3 ruby ruby-bundler ruby-dev g++ musl-dev make docker      # packages to support building docker images
